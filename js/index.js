...
displayOrder = () => {
    ...
    for(let i = 0; i < pizzaOrder.length; i++){
        ...
        <div class="card" style="width: 18rem;">
            <img class="card-img-top" src="assets/classic-cheese-pizza-FT-RECIPE0422-31a2c938fc2546c9a07b7011658cfd05.jpg" alt="Card image cap">
            <div class="card-body">
                ...
                <p class="card-text"><strong>Cost:</strong> ${price}.00</p>
            </div>
        </div>`
